...
- [`advanced_xyz2tab`](https://github.com/radi0sus/advanced_xyz2tab/) *Convert XYZ data to bond lengths & angles, calculate contacts, planes, dihedral angles, ring parameters, CShM, VdW-Volume and area, several molecular radii & diffusion coefficients, and print tables.* `JavaScript` `HTML`
